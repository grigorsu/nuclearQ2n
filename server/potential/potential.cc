// old: printf "\n\n\n\n\n"; g++ potential.cc -lgmpxx -lgmp -lmpfr -lgsl -lgslcblas -std=c++11 -o potential.exe  && ./potential.exe
// LD_LIBRARY_PATH='/usr/local/lib'
// export LD_LIBRARY_PATH;
//potential.exe -i ./conf.i.txt -o ./conf.potential.txt -r ./plot.R
// g++ potential.cc         -lgsl -lgslcblas -std=c++11 -o   potential.exe 
// h='../conf'; f='potential';  printf "\n\n\n"; g++ $f.cc -lgsl -lgslcblas -std=c++11 -o $f.exe && ./$f.exe -i $h/conf.makeplot.txt -o $h/conf.$f.txt -r $h/$f.R

// set PATH=D:\ProgramFiles\MinGW3264\mingw64\bin;%PATH%
// g++ potential.cc -static -static-libgcc -static-libstdc++ -I"d:/ProgramFiles/MinGW3264/mingw64/include/" -L"d:/ProgramFiles/MinGW3264/mingw64/lib/" -lgsl -lgslcblas -lm -o w_potential.exe
